...
export default function Cookies() {
  return (
    <div className="w-[300px] h-[220px] bg-white flex flex-col items-center justify-center py-[20px] px-[30px] gap-[13px] relative overflow-hidden shadow-[2px_2px_20px_rgba(0,0,0,0.062)]">
      <svg
        version="1.1"
        id="cookieSvg"
        x="0px"
      ...
      >
        <g>
          <path
            ...
            c-1.06-3.05-1.28-6.59-0.61-10.35C47.27,5.95,34.3,11.36,24.41,20.18C13.74,29.69,6.66,43.15,5.84,58.29l0,0.05v0h0
            l-0.01,0.13v0C5.07,73.72,10.55,87.82,20.02,98.3c9.44,10.44,22.84,17.29,38,18.1l0.05,0h0v0l0.13,0.01h0
            c15.24,0.77,29.35-4.71,39.83-14.19c10.44-9.44,17.29-22.84,18.1-38l0-0.05v0h0l0.01-0.13v0
            c0.07-1.34,0.09-2.64,0.06-3.91C112.98,61.34,109.96,61.51,107.13,60.74L107.13,60.74z M116.15,64.04L116.15,64.04
            L116.15,64.04L116.15,64.04z M58.21,116.42L58.21,116.42L58.21,116.42L58.21,116.42z"
          ></path>
        </g>
      </svg>
      <p className="text-[1.2em] font-extrabold text-[#1a1a1a]">We use cookies.</p>
      <p className="text-center text-[0.7em] font-semibold text-[#636363]">
        This website uses cookies to ensure you get the best experience on our site.
      </p>
      <div className="flex gap-[20px]">
        <button className="w-[80px] h-[30px] bg-[#7b57ff] transition duration-200 text-[#f1f1f1] cursor-pointer font-semibold rounded-[20px] hover:bg-[#9173ff]">
          Allow
        </button>
        <button className="w-[80px] h-[30px] bg-[#dadada] transition duration-200 text-[#2e2e2e] cursor-pointer font-semibold rounded-[20px] hover:bg-[#ebebeb]">
          Decline
        </button>
      </div>
    </div>
